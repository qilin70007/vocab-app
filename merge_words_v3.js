...
// Get the actual project directory by listing E:\Tina
const tinaDir = fs.readdirSync(path.join('E:', 'Tina'));
console.log('Tina dir contents:', tinaDir);

// Find the folder that contains our project
const projectFolder = tinaDir.find(d => {
  const fullPath = path.join('E:', 'Tina', d);
  return fs.existsSync(path.join(fullPath, 'data', 'words.json'));
});
...
const BASE = path.join('E:', 'Tina', projectFolder);
console.log('Project dir:', BASE);
